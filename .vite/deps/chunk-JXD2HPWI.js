...
function ThemeProvider(_ref) {
  let { theme: themeInput } = _ref,
    props = _objectWithoutPropertiesLoose(_ref, _excluded7)
...
function extendTheme(options = {}, ...args) {
  ...
  const {
    ...
    input = _objectWithoutPropertiesLoose(options, _excluded8)
  ...
  Object.keys(theme.colorSchemes).forEach((key) => {
    ...
    if (key === 'light') {
      setColor(
        palette.Alert,
        'errorColor',
        private_safeDarken(palette.error.light, 0.6),
      )
      setColor(
        palette.Alert,
        'infoColor',
        private_safeDarken(palette.info.light, 0.6),
      )
      setColor(
        palette.Alert,
        'successColor',
        private_safeDarken(palette.success.light, 0.6),
      )
      setColor(
        palette.Alert,
        'warningColor',
        private_safeDarken(palette.warning.light, 0.6),
      )
      setColor(
        palette.Alert,
        'errorFilledBg',
      ...
      setColor(
        palette.Alert,
        'errorStandardBg',
        private_safeLighten(palette.error.light, 0.9),
      )
      setColor(
        palette.Alert,
        'infoStandardBg',
        private_safeLighten(palette.info.light, 0.9),
      )
      setColor(
        palette.Alert,
        'successStandardBg',
        private_safeLighten(palette.success.light, 0.9),
      )
      setColor(
        palette.Alert,
        'warningStandardBg',
        private_safeLighten(palette.warning.light, 0.9),
      )
      setColor(
        palette.Alert,
        'errorIconColor',
      ...
      setColor(
        ...
        'primaryBg',
        private_safeLighten(palette.primary.main, 0.62),
      )
      setColor(
        palette.LinearProgress,
        'secondaryBg',
        private_safeLighten(palette.secondary.main, 0.62),
      )
      setColor(
        palette.LinearProgress,
        'errorBg',
        private_safeLighten(palette.error.main, 0.62),
      )
      setColor(
        palette.LinearProgress,
        'infoBg',
        private_safeLighten(palette.info.main, 0.62),
      )
      setColor(
        palette.LinearProgress,
        'successBg',
        private_safeLighten(palette.success.main, 0.62),
      )
      setColor(
        palette.LinearProgress,
        'warningBg',
        private_safeLighten(palette.warning.main, 0.62),
      )
      setColor(
        palette.Skeleton,
        'bg',
      ...
      setColor(
        ...
        'fabHoverBg',
        private_safeEmphasize(palette.background.paper, 0.15),
      )
      setColor(
      ...
      setColor(
        palette.TableCell,
        'border',
        private_safeLighten(private_safeAlpha(palette.divider, 1), 0.88),
      )
      setColor(
        palette.Tooltip,
        'bg',
        private_safeAlpha(palette.grey[700], 0.92),
      )
    } else {
      setColor(
        palette.Alert,
        'errorColor',
        private_safeLighten(palette.error.light, 0.6),
      )
      setColor(
        palette.Alert,
        'infoColor',
        private_safeLighten(palette.info.light, 0.6),
      )
      setColor(
        palette.Alert,
        'successColor',
        private_safeLighten(palette.success.light, 0.6),
      )
      setColor(
        palette.Alert,
        'warningColor',
        private_safeLighten(palette.warning.light, 0.6),
      )
      setColor(
        palette.Alert,
        'errorFilledBg',
      ...
      setColor(
        palette.Alert,
        'errorStandardBg',
        private_safeDarken(palette.error.light, 0.9),
      )
      setColor(
        palette.Alert,
        'infoStandardBg',
        private_safeDarken(palette.info.light, 0.9),
      )
      setColor(
        palette.Alert,
        'successStandardBg',
        private_safeDarken(palette.success.light, 0.9),
      )
      setColor(
        palette.Alert,
        'warningStandardBg',
        private_safeDarken(palette.warning.light, 0.9),
      )
      setColor(
        palette.Alert,
        'errorIconColor',
      ...
      setColor(
        palette.LinearProgress,
        'primaryBg',
        private_safeDarken(palette.primary.main, 0.5),
      )
      setColor(
        palette.LinearProgress,
        'secondaryBg',
        private_safeDarken(palette.secondary.main, 0.5),
      )
      setColor(
        palette.LinearProgress,
        'errorBg',
        private_safeDarken(palette.error.main, 0.5),
      )
      setColor(
        palette.LinearProgress,
        'infoBg',
        private_safeDarken(palette.info.main, 0.5),
      )
      setColor(
        palette.LinearProgress,
        'successBg',
        private_safeDarken(palette.success.main, 0.5),
      )
      setColor(
        palette.LinearProgress,
        'warningBg',
        private_safeDarken(palette.warning.main, 0.5),
      )
      setColor(
        palette.Skeleton,
        'bg',
      ...
      setColor(
        palette.Switch,
        'primaryDisabledColor',
        private_safeDarken(palette.primary.main, 0.55),
      )
      setColor(
        palette.Switch,
        'secondaryDisabledColor',
        private_safeDarken(palette.secondary.main, 0.55),
      )
      setColor(
        palette.Switch,
        'errorDisabledColor',
        private_safeDarken(palette.error.main, 0.55),
      )
      setColor(
        palette.Switch,
        'infoDisabledColor',
        private_safeDarken(palette.info.main, 0.55),
      )
      setColor(
        palette.Switch,
        'successDisabledColor',
        private_safeDarken(palette.success.main, 0.55),
      )
      setColor(
        palette.Switch,
        'warningDisabledColor',
        private_safeDarken(palette.warning.main, 0.55),
      )
      setColor(
        palette.TableCell,
        'border',
        private_safeDarken(private_safeAlpha(palette.divider, 1), 0.68),
      )
      setColor(
        palette.Tooltip,
        'bg',
...
//# sourceMappingURL=chunk-JXD2HPWI.js.map
