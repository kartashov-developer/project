    ...
    if (true) {
      ;(function () {
        ...
        var ReactSharedInternals =
          React28.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED
...
var createUnsafeSelectorsAlarm = function createUnsafeSelectorsAlarm2(
  cache2,
) {
...
var cursor
var serializeStyles = function serializeStyles2(
  args,
  registered,
  mergedProps,
) {
...
var useInsertionEffectWithLayoutFallback =
  useInsertionEffect2 || React9.useLayoutEffect
...
var Emotion = withEmotionCache(function (props, cache2, ref) {
  ...
  var serialized = serializeStyles(
    registeredStyles,
    void 0,
    React10.useContext(ThemeContext),
  )
  ...
  return React10.createElement(
    React10.Fragment,
    null,
    React10.createElement(Insertion, {
      cache: cache2,
      serialized,
...
var Global = withEmotionCache(function (props, cache2) {
  ...
  var serialized = serializeStyles(
    [styles],
    void 0,
    React11.useContext(ThemeContext),
  )
  if (!isBrowser2) {
    var _ref
...
var ClassNames = withEmotionCache(function (props, cache2) {
  ...
  return React11.createElement(
    React11.Fragment,
    null,
    React11.createElement(Insertion3, {
      cache: cache2,
      serializedArr,
    }),
    ele,
  ...
  return function () {
    ...
    var Styled = withEmotionCache(function (props, cache2, ref) {
      ...
      return React12.createElement(
        React12.Fragment,
        null,
        React12.createElement(Insertion5, {
          cache: cache2,
          serialized,
...
function GlobalStyles(props) {
  const { styles, defaultTheme: defaultTheme4 = {} } = props
  const globalStyles =
    typeof styles === 'function'
      ? (themeInput) =>
          styles(isEmpty(themeInput) ? defaultTheme4 : themeInput)
      : styles
...
function createBreakpoints(breakpoints2) {
  const {
    ...
    other = _objectWithoutPropertiesLoose(breakpoints2, _excluded)
        ...
        if (value !== null && value !== void 0) {
          if (typeof value === 'object') {
            if (config[styleKey]) {
              css2 = merge_default(
                css2,
                getThemeValue2(styleKey, value, theme, config),
              )
            } else {
...
true
  ? (GlobalStyles2.propTypes = {
       ...
       * @ignore
       */
      styles: import_prop_types8.default.oneOfType([
        import_prop_types8.default.array,
  ...
  Object.keys(other)
    ...
    .forEach((key) => {
      if (key === 'color') {
        ...
        classKey += `${
          isEmpty2(classKey) ? key : capitalize(key)
...
true
  ? (ThemeProvider3.propTypes = {
       ...
       * A theme object. You can provide a function to extend the outer theme.
       */
      theme: import_prop_types11.default.oneOfType([
...
function useCurrentColorScheme(options) {
  ...
  const setMode = React23.useCallback(
    (mode) => {
  ...
  const setColorScheme = React23.useCallback(
    (value) => {
      if (!value) {
        setState((currentState) => {
          try {
  ...
  const handleMediaQuery = React23.useCallback(
    (e) => {
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider({
    ...
    const _ref = scopedTheme || themeProp,
      ...
      restThemeProp = _objectWithoutPropertiesLoose(_ref, _excluded7)
  ...
  true
    ? (CssVarsProvider.propTypes = {
         ...
         */
        defaultColorScheme: import_prop_types12.default.oneOfType([
...
function createCssVarsTheme(theme) {
  const { cssVarPrefix, shouldSkipGeneratingVar } = theme,
    otherTheme = _objectWithoutPropertiesLoose(theme, _excluded9)
  return _extends(
    {},
    theme,
    prepareCssVars_default(otherTheme, {
      prefix: cssVarPrefix,
      shouldSkipGeneratingVar,
    }),
  )
...
true
  ? (Container.propTypes = {
       ...
       * @default 'lg'
       */
      maxWidth: import_prop_types14.default.oneOfType([
...
var traverseBreakpoints = (breakpoints2, responsive, iterator) => {
  ...
  if (Array.isArray(responsive)) {
      ...
      iterator((responsiveStyles, style4) => {
        if (index <= breakpoints2.keys.length - 1) {
          if (index === 0) {
            ...
            responsiveStyles[breakpoints2.up(breakpoints2.keys[index])] =
              style4
          }
        }
      }, breakpointValue)
    ...
    const keys =
      Object.keys(responsive).length > breakpoints2.keys.length
        ? breakpoints2.keys
        : filterBreakpointKeys(breakpoints2.keys, Object.keys(responsive))
    keys.forEach((key) => {
...
function createGrid(options = {}) {
  ...
  const Grid2 = React26.forwardRef(function Grid3(inProps, ref) {
    ...
    let result = (0, import_jsx_runtime11.jsx)(
      GridRoot,
      _extends(
        {
          ref,
...
true
  ? (Grid.propTypes = {
       ...
       * @default 12
       */
      columns: import_prop_types16.default.oneOfType([
       ...
       */
      columnSpacing: import_prop_types16.default.oneOfType([
        import_prop_types16.default.arrayOf(
       ...
       * @default false
       */
      lg: import_prop_types16.default.oneOfType([
        import_prop_types16.default.oneOf(['auto']),
        import_prop_types16.default.number,
       ...
       * The value is applied for the `lg` breakpoint and wider screens if not overridden.
       */
      lgOffset: import_prop_types16.default.oneOfType([
        import_prop_types16.default.oneOf(['auto']),
        import_prop_types16.default.number,
      ]),
      /**
       ...
       * @default false
       */
      md: import_prop_types16.default.oneOfType([
        import_prop_types16.default.oneOf(['auto']),
        import_prop_types16.default.number,
        import_prop_types16.default.bool,
      ]),
       ...
       * The value is applied for the `md` breakpoint and wider screens if not overridden.
       */
      mdOffset: import_prop_types16.default.oneOfType([
        import_prop_types16.default.oneOf(['auto']),
        import_prop_types16.default.number,
      ]),
      /**
       ...
       * It overrides the value of the `spacing` prop.
       */
      rowSpacing: import_prop_types16.default.oneOfType([
        import_prop_types16.default.arrayOf(
          import_prop_types16.default.oneOfType([
            import_prop_types16.default.number,
            import_prop_types16.default.string,
       ...
       * @default false
       */
      sm: import_prop_types16.default.oneOfType([
        import_prop_types16.default.oneOf(['auto']),
        import_prop_types16.default.number,
        import_prop_types16.default.bool,
      ]),
       ...
       * The value is applied for the `sm` breakpoint and wider screens if not overridden.
       */
      smOffset: import_prop_types16.default.oneOfType([
        import_prop_types16.default.oneOf(['auto']),
        import_prop_types16.default.number,
      ]),
      /**
       ...
       * @default 'wrap'
       */
      wrap: import_prop_types16.default.oneOf([
        'nowrap',
        'wrap-reverse',
        'wrap',
      ]),
       ...
       * @default false
       */
      xl: import_prop_types16.default.oneOfType([
        import_prop_types16.default.oneOf(['auto']),
        import_prop_types16.default.number,
        import_prop_types16.default.bool,
      ]),
       ...
       * The value is applied for the `xl` breakpoint and wider screens if not overridden.
       */
      xlOffset: import_prop_types16.default.oneOfType([
        import_prop_types16.default.oneOf(['auto']),
        import_prop_types16.default.number,
      ]),
      /**
       ...
       * @default false
       */
      xs: import_prop_types16.default.oneOfType([
        import_prop_types16.default.oneOf(['auto']),
        import_prop_types16.default.number,
        import_prop_types16.default.bool,
      ]),
       ...
       */
      xsOffset: import_prop_types16.default.oneOfType([
        import_prop_types16.default.oneOf(['auto']),
        import_prop_types16.default.number,
      ]),
    })
...
function joinChildren(children, separator) {
  ...
  return childrenArray.reduce((output, child, index) => {
    ...
    if (index < childrenArray.length - 1) {
      output.push(
        React27.cloneElement(separator, {
          key: `separator-${index}`,
        }),
      )
    }
  ...
  if (ownerState.spacing) {
    ...
    if (typeof directionValues === 'object') {
      Object.keys(directionValues).forEach(
        (breakpoint, index, breakpoints2) => {
          const directionValue = directionValues[breakpoint]
          if (!directionValue) {
            const previousDirectionValue =
              index > 0 ? directionValues[breakpoints2[index - 1]] : 'column'
...
true
  ? (Stack.propTypes = {
       ...
       * @default 'column'
       */
      direction: import_prop_types18.default.oneOfType([
        import_prop_types18.default.oneOf([
          'column-reverse',
          'column',
          'row-reverse',
          'row',
       ...
       * @default 0
       */
      spacing: import_prop_types18.default.oneOfType([
        import_prop_types18.default.arrayOf(
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-MKHZ424I.js.map
