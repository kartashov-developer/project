...
function createRouter(init) {
  ...
  async function startRedirectNavigation(state2, redirect3, _temp) {
    ...
    if (ABSOLUTE_URL_REGEX.test(redirect3.location) && isBrowser) {
      ...
      if (
        routerWindow.location.origin !== url.origin ||
        isDifferentBasename
      ) {
        if (replace) {
...
function getMatchesToLoad(
  ...
  fetchLoadMatches.forEach((f, key) => {
    ...
    let isPerformingInitialLoad =
      fetcher &&
      fetcher.state !== 'idle' &&
      fetcher.data === void 0 && // If a fetcher.load redirected then it'll be "loading" without any data
...
react-router/dist/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-7MXD6AJL.js.map
