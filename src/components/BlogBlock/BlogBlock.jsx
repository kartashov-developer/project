...
const BlogBlock = () => {
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: '16px', alignItems: 'flex-start', width: '269px' }}>
      <Box
        sx={{ height: '180px', width: '269px', background: 'url("../../../public/static/images/placeholders/RectangleMedium.jpg"), lightgray 50% / cover no-repeat' }}
      />
