...
const BlogPosts = () => {
  ...
  return (
    <Container sx={{ padding: '64px 0' }}>
      <SectionHeader sectionHeader={'Read our Blog posts'} buttonText={'Go to Blog'} />
      <WrapperContainer disableGutters>
        ...
        <Container disableGutters sx={{
          ...
          <BlogBlockRow
            srcImage={'url("../../../public/static/images/placeholders/RectangleSmall1.png"), lightgray 50% / cover no-repeat'}
          />
          <BlogBlockRow
            srcImage={'url("../../../public/static/images/placeholders/RectangleSmall2.png"), lightgray 50% / cover no-repeat'}
          />
          <BlogBlockRow
            srcImage={'url("../../../public/static/images/placeholders/RectangleSmall3.png"), lightgray 50% / cover no-repeat'}
          />
        </Container>
      </WrapperContainer>
    </Container>
